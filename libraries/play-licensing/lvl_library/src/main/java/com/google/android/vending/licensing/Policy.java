...
public interface Policy {
     ...
     * @param signature Signature of the rawData
     * @param actualErrorCode Licensing server response code
     */
    void processServerResponse(int response, ResponseData rawData, String signature, LicenseValidationResultCode actualErrorCode);
