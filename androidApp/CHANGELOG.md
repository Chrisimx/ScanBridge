...
## [2.1.4] - 2026-03-14
### Fixed
- Crash when rotating or cropping black-and-white scans
...
### Fixed
- Crash when trying to share scans with other apps
- "Remember scan settings" not working
...
### Fixed
- Improve scanner compatibility

And multiple other improvements...
