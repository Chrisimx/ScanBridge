...
@Composable
fun <T: SettingValue> StringValue.toLocalizedName(scannerConcept: ScannerConcept<T>): String {
    return when (scannerConcept) {
...
@Composable
fun <T: SettingValue> SettingValue.toLocalizedName(scannerConcept: ScannerConcept<T>): String {
    return when (this) {
