...
@Composable
fun CustomPrinterDialog(onDismiss: () -> Unit, onConnectClicked: (String, HttpUrl, Boolean) -> Unit) {
    ...
    Dialog(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    stringResource(R.string.custom_printer_dialog_title),
                ...
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(R.string.url_ipp_resource)) },
                    placeholder = { Text("http://192.168.178.2:631/ipp/print") },
                    supportingText = {
                        urlErrorState?.let {
                            Text(
                                it,
